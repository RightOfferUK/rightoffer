...
const ForSellers = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-white py-20 lg:py-32" id="for-sellers">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              className="text-xl text-gray-600 font-dm-sans mb-8 leading-relaxed"
              variants={itemVariants}
            >
